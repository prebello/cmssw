...
# with command line options: SMS-T1tttt_mGl-1500_mLSP-100_13TeV-pythia8_cfi --conditions auto:run2_mc --pileup_input das:/RelValMinBiasFS_13_ForMixing/CMSSW_8_0_19-80X_mcRun2_asymptotic_2016_TrancheIV_v2_Tr4GT_v2_FastSim-v1/GEN-SIM-RECO --fast -n 10 --era Run2_2016 --eventcontent FEVTDEBUGHLT,DQM --relval 100000,500 -s GEN,SIM,RECOBEFMIX,DIGI:pdigi_valid,L1,DIGI2RAW,L1Reco,RECO,EI,HLT:@relval2016,VALIDATION:@standardValidation,DQM:@standardDQM --beamspot Realistic50ns13TeVCollision --datatier GEN-SIM-DIGI-RECO,DQMIO --pileup AVE_35_BX_25ns --io FS_SMS-T1tttt_mGl-1500_mLSP-100_13_UP15_PU25.io --python FS_SMS-T1tttt_mGl-1500_mLSP-100_13_UP15_PU25.py --conditions 80X_mcRun2_asymptotic_2016_TrancheIV_v2 --no_exec --fileout file:step1.root
