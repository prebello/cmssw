...
#step1Up2017Defaults = merge ([{'--conditions':'auto:phase1_2017_realistic','--era':'Run2_2017'},step1Up2015Defaults])
### temporary GT
step1Up2017Defaults = merge ([{'--conditions':'92X_upgrade2017_realistic_v1','--era':'Run2_2017'},step1Up2015Defaults])
...
#    'CMSSW_7_1_0_pre5-START71_V1-v2',                      # 3 8 TeV , for the one sample which is part of the routine relval production (RelValZmumuJets_Pt_20_300, because of -v2)
    ...
    'CMSSW_9_2_2-91X_mcRun2_asymptotic_v3_FastSim-v1',    # 7 - fastSim MinBias for mixing
    'CMSSW_9_2_2-PU25ns_91X_mcRun2_asymptotic_v3_FastSim-v1',# 8 - fastSim premixed MinBias
    ...
    'CMSSW_9_2_2-92X_upgrade2017_realistic_v1-v1',     # 13 - 13 TeV samples with GEN-SIM from PhaseI upgrade
    'CMSSW_9_1_0_pre3-PU25ns_91X_upgrade2017_realistic_v3-v1',     # 14 - fullSim PU 25ns UP17 premix
    ]
...
# temporary GT
                 '--conditions'  :'92X_upgrade2017_realistic_v1',
                 '--datatier'    :'GEN-SIM-DIGI-RAW-HLTDEBUG',
                 '--eventcontent':'FEVTDEBUGHLT',
                 '--era'         :'Run2_2017',
                 '-n'            :'10',
...
# temporary GT
premixUp2017Defaults = merge([{'--conditions':'92X_upgrade2017_realistic_v1'},
                                  {'--era':'Run2_2017'},
                                  premixUp2015Defaults])
...
#        {'--conditions':'auto:phase1_2017_realistic',
# temporary GT
        {'--conditions':'92X_upgrade2017_realistic_v1','--era':'Run2_2017','--customise':'SimGeneral/DataMixingModule/customiseForPremixingInput.customiseForPreMixingInput'},
        step3Up2015Defaults])
...
# temporary GT
steps['HARVESTUP17_PU25']=merge([{'--conditions':'92X_upgrade2017_realistic_v1','--era' : 'Run2_2017'},steps['HARVESTUP15']])
...
#        PUDataSets[ds]={'-n':10,'--pileup':'AVE_50_BX_25ns','--pileup_input':'das:/RelValMinBias_14/%s/GEN-SIM'%(name,)}
