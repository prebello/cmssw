...
#    'CMSSW_7_1_0_pre5-START71_V1-v2',                      # 3 8 TeV , for the one sample which is part of the routine relval production (RelValZmumuJets_Pt_20_300, because of -v2)
    ...
    'CMSSW_9_3_0_pre2-PU25ns_92X_mcRun2_asymptotic_v2_FastSim-v1',# 8 - fastSim premixed MinBias
    'CMSSW_9_3_0_pre2-92X_upgrade2017_realistic_v7-v1', 	           # 9 - Run2 HI GEN-SIM
    ...
    'CMSSW_9_3_0_pre2-92X_upgrade2017_realistic_v7-v1',     # 13 - 13 TeV samples with GEN-SIM from PhaseI upgrade
    'CMSSW_9_3_0_pre2-PU25ns_92X_upgrade2017_realistic_v7-v1',     # 14 - fullSim PU 25ns UP17 premix
    ]
...
steps['DIGIHIMIX']=merge([{'-s':'DIGI:pdigi_hi,L1,DIGI2RAW,HLT:HIon', '-n':2}, hiDefaults2018, {'--pileup':'HiMix'}, PUHI, step2Upg2017Defaults])
...
step2HImixDefaults=merge([{'-n':'2', #too slow for 10 events/hour
                           '--pileup':'HiMix',                        
                           },hiDefaults2018,step1Up2017Defaults])
