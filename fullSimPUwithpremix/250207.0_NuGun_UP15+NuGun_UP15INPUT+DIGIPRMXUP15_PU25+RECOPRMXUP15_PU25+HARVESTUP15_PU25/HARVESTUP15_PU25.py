...
# with command line options: step4 --filetype DQM --conditions auto:run2_mc --mc -s HARVESTING:@standardValidation+@standardDQM+@miniAODValidation+@miniAODDQM --era Run2_2016 --io HARVESTUP15_PU25.io --python HARVESTUP15_PU25.py --conditions 80X_mcRun2_asymptotic_2016_TrancheIV_v2 -n 100 --no_exec --filein file:step3_inDQM.root --fileout file:step4.root
