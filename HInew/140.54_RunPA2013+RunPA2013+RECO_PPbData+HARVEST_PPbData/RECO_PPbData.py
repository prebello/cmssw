...
# with command line options: step2 --conditions auto:run1_data -s RAW2DIGI,L1Reco,RECO,ALCA:TkAlMinBias+TkAlMuonIsolatedPA+TkAlUpsilonMuMuPA+TkAlZMuMuPA,SKIM:PAZMM+PAZEE+PAMinBias,EI,DQM --process reRECO --data --era Run1_pA --eventcontent AOD,DQM --runUnscheduled --scenario pp --datatier AOD,DQMIO --io RECO_PPbData.io --python RECO_PPbData.py -n 100 --no_exec --filein filelist:step1_dasquery.log --lumiToProcess step1_lumiRanges.log --fileout file:step2.root --nThreads 4
import FWCore.ParameterSet.Config as cms

from Configuration.StandardSequences.Eras import eras

process = cms.Process('reRECO',eras.Run1_pA)
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('/store/hidata/HIRun2013/PAMinBiasUPC/RAW/v1/000/211/313/00000/2CD4EFBC-6F6D-E211-9AF6-001D09F241F0.root', 
        '/store/hidata/HIRun2013/PAMinBiasUPC/RAW/v1/000/211/313/00000/6E6000BA-706D-E211-B87E-001D09F2924F.root', 
        '/store/hidata/HIRun2013/PAMinBiasUPC/RAW/v1/000/211/313/00000/78C280CB-7C6D-E211-9C8F-0019B9F72CE5.root'),
    lumisToProcess = cms.untracked.VLuminosityBlockRange("211313:1-211313:268435455"),
...
process.ALCARECOStreamTkAlMuonIsolatedPA = cms.OutputModule("PoolOutputModule",
    SelectEvents = cms.untracked.PSet(
        SelectEvents = cms.vstring('pathALCARECOTkAlMuonIsolatedPA')
    ),
    dataset = cms.untracked.PSet(
        dataTier = cms.untracked.string('ALCARECO'),
        filterName = cms.untracked.string('TkAlMuonIsolatedPA')
    ),
    eventAutoFlushCompressedSize = cms.untracked.int32(5242880),
    fileName = cms.untracked.string('TkAlMuonIsolatedPA.root'),
    outputCommands = cms.untracked.vstring('drop *', 
...
process.ALCARECOStreamTkAlUpsilonMuMuPA = cms.OutputModule("PoolOutputModule",
    SelectEvents = cms.untracked.PSet(
        SelectEvents = cms.vstring('pathALCARECOTkAlUpsilonMuMuPA')
    ),
    dataset = cms.untracked.PSet(
        dataTier = cms.untracked.string('ALCARECO'),
        filterName = cms.untracked.string('TkAlUpsilonMuMuPA')
    ),
    eventAutoFlushCompressedSize = cms.untracked.int32(5242880),
    fileName = cms.untracked.string('TkAlUpsilonMuMuPA.root'),
    outputCommands = cms.untracked.vstring('drop *', 
...
process.ALCARECOStreamTkAlZMuMuPA = cms.OutputModule("PoolOutputModule",
    SelectEvents = cms.untracked.PSet(
        SelectEvents = cms.vstring('pathALCARECOTkAlZMuMuPA')
    ),
    dataset = cms.untracked.PSet(
        dataTier = cms.untracked.string('ALCARECO'),
        filterName = cms.untracked.string('TkAlZMuMuPA')
    ),
    eventAutoFlushCompressedSize = cms.untracked.int32(5242880),
    fileName = cms.untracked.string('TkAlZMuMuPA.root'),
    outputCommands = cms.untracked.vstring('drop *', 
...
process.SKIMStreamPAMinBias = cms.OutputModule("PoolOutputModule",
    SelectEvents = cms.untracked.PSet(
        SelectEvents = cms.vstring('minBiasSkimPath')
    ),
    dataset = cms.untracked.PSet(
        dataTier = cms.untracked.string('RAW-RECO'),
        filterName = cms.untracked.string('PAMinBias')
    ),
    eventAutoFlushCompressedSize = cms.untracked.int32(5242880),
    fileName = cms.untracked.string('PAMinBias.root'),
    outputCommands = cms.untracked.vstring( ('drop *', 
        'drop *', 
...
process.SKIMStreamPAZEE = cms.OutputModule("PoolOutputModule",
    SelectEvents = cms.untracked.PSet(
        SelectEvents = cms.vstring('zEESkimPath')
    ),
    dataset = cms.untracked.PSet(
        dataTier = cms.untracked.string('RAW-RECO'),
        filterName = cms.untracked.string('PAZEE')
    ),
    eventAutoFlushCompressedSize = cms.untracked.int32(5242880),
    fileName = cms.untracked.string('PAZEE.root'),
    outputCommands = cms.untracked.vstring( ('drop *', 
        'drop *', 
        'keep  FEDRawDataCollection_rawDataCollector_*_*', 
        'keep  FEDRawDataCollection_source_*_*', 
...
process.SKIMStreamPAZMM = cms.OutputModule("PoolOutputModule",
    SelectEvents = cms.untracked.PSet(
        SelectEvents = cms.vstring('zMMSkimPath')
    ),
    dataset = cms.untracked.PSet(
        dataTier = cms.untracked.string('RAW-RECO'),
        filterName = cms.untracked.string('PAZMM')
    ),
    eventAutoFlushCompressedSize = cms.untracked.int32(5242880),
    fileName = cms.untracked.string('PAZMM.root'),
    outputCommands = cms.untracked.vstring( ('drop *', 
        'drop *', 
        'keep  FEDRawDataCollection_rawDataCollector_*_*', 
        'keep  FEDRawDataCollection_source_*_*', 
...
# Other statements
process.ALCARECOEventContent.outputCommands.extend(process.OutALCARECOTkAlMuonIsolatedPA_noDrop.outputCommands)
process.ALCARECOEventContent.outputCommands.extend(process.OutALCARECOTkAlMinBias_noDrop.outputCommands)
process.ALCARECOEventContent.outputCommands.extend(process.OutALCARECOTkAlZMuMuPA_noDrop.outputCommands)
process.ALCARECOEventContent.outputCommands.extend(process.OutALCARECOTkAlUpsilonMuMuPA_noDrop.outputCommands)
...
process.ALCARECOStreamTkAlMuonIsolatedPAOutPath = cms.EndPath(process.ALCARECOStreamTkAlMuonIsolatedPA)
process.ALCARECOStreamTkAlUpsilonMuMuPAOutPath = cms.EndPath(process.ALCARECOStreamTkAlUpsilonMuMuPA)
process.ALCARECOStreamTkAlZMuMuPAOutPath = cms.EndPath(process.ALCARECOStreamTkAlZMuMuPA)
process.SKIMStreamPAMinBiasOutPath = cms.EndPath(process.SKIMStreamPAMinBias)
process.SKIMStreamPAZEEOutPath = cms.EndPath(process.SKIMStreamPAZEE)
process.SKIMStreamPAZMMOutPath = cms.EndPath(process.SKIMStreamPAZMM)

# Schedule definition
process.schedule = cms.Schedule(process.raw2digi_step,process.L1Reco_step,process.reconstruction_step,process.pathALCARECOTkAlMuonIsolatedPA,process.pathALCARECOTkAlMinBias,process.pathALCARECOTkAlZMuMuPA,process.pathALCARECOTkAlUpsilonMuMuPA,process.zEESkimPath,process.minBiasSkimPath,process.zMMSkimPath,process.eventinterpretaion_step,process.dqmoffline_step,process.dqmofflineOnPAT_step,process.AODoutput_step,process.DQMoutput_step,process.ALCARECOStreamTkAlMinBiasOutPath,process.ALCARECOStreamTkAlMuonIsolatedPAOutPath,process.ALCARECOStreamTkAlUpsilonMuMuPAOutPath,process.ALCARECOStreamTkAlZMuMuPAOutPath,process.SKIMStreamPAMinBiasOutPath,process.SKIMStreamPAZEEOutPath,process.SKIMStreamPAZMMOutPath)
