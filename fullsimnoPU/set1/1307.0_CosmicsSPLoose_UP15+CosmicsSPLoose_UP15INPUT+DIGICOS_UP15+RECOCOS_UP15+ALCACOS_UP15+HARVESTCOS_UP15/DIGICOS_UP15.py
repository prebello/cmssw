...
# with command line options: step2 --conditions auto:run2_mc_cosmics -s DIGI:pdigi_valid,L1,DIGI2RAW,HLT:@relval2016 --scenario cosmics --datatier GEN-SIM-DIGI-RAW -n 10 --era Run2_2016 --eventcontent FEVTDEBUG --io DIGICOS_UP15.io --python DIGICOS_UP15.py --conditions 80X_mcRun2_asymptotic_2016_TrancheIV_v2 --no_exec --filein filelist:step1_dasquery.log --fileout file:step2.root --nThreads 4
...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring('/store/relval/CMSSW_7_1_20_patch2/RelValCosmicsSPLoose_UP15/GEN-SIM/MCRUN2_71_V1_GsRealBS-v1/00000/5843AF5A-F681-E511-94FB-0025905B858C.root', 
        '/store/relval/CMSSW_7_1_20_patch2/RelValCosmicsSPLoose_UP15/GEN-SIM/MCRUN2_71_V1_GsRealBS-v1/00000/B801CE54-F681-E511-BB95-00261894380D.root'),
