...
# with command line options: step4 --conditions auto:run2_mc -s HARVESTING:@standardValidation+@standardDQM+@miniAODValidation+@miniAODDQM --filetype DQM -n 5 --era Run2_2016 --mc --io HARVESTUP15.io --python HARVESTUP15.py --conditions 80X_mcRun2_asymptotic_2016_TrancheIV_v2 --no_exec --filein file:step3_inDQM.root --fileout file:step4.root
