...
# with command line options: step4 --filetype DQM --mc --conditions auto:run2_mc --era Run2_2016 -s HARVESTING:validationHarvesting+dqmHarvesting --io HARVESTMINUP15.io --python HARVESTMINUP15.py --conditions 80X_mcRun2_asymptotic_2016_TrancheIV_v2 -n 100 --no_exec --filein file:step3_inDQM.root --fileout file:step4.root
