...
# with command line options: step3 --conditions auto:run2_mc --fast -n 100 --era Run2_2016 --eventcontent MINIAODSIM --runUnscheduled --filein file:step1.root -s PAT --datatier MINIAODSIM --mc --io MINIAODMCUP15FS.io --python MINIAODMCUP15FS.py --conditions 80X_mcRun2_asymptotic_2016_TrancheIV_v2 --no_exec --fileout file:step3.root
import FWCore.ParameterSet.Config as cms

from Configuration.StandardSequences.Eras import eras

process = cms.Process('PAT',eras.Run2_2016,eras.fastSim)
